...
public class MainActivity extends AppCompatActivity {
    final private int PERM_CODE_WRITE_EXTERNAL_STORAGE = 0;
    ...
    class saveButtonOnClick implements View.OnClickListener {
        public void onClick(View v) {
            while (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(MainActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERM_CODE_WRITE_EXTERNAL_STORAGE);
            }
